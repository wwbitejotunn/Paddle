...
void PostConv2dAddLayernormFusePass::ApplyImpl(ir::Graph *graph) const {
    ...
    auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
        ...
        VarDesc* post_conv2d_transpose2_out_desc(transpose2_30_out->Var());
        ...
        post_conv2d_transpose2_out_desc->SetShape({conv2d_out_shape[0],
                                                  ...
                                                  conv2d_out_shape[1]});
        //todo
        // post_conv2d_transpose2_out_desc->SetDataType(transpose2_30_out->Var()->GetDataTypes()[0]);
        ...
        prln_residual_bias_op_desc.SetInput("X",{post_conv2d_transpose2_out_node->Name()});
        ...
        prln_residual_bias_op_desc.SetOutput("Out_1",{layernorm_40_out_y->Name()});
        ...
        IR_NODE_LINK_TO(post_conv2d_transpose2_out_node,post_conv2d_add_layernorm_op);
