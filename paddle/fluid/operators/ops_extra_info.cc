...
ExtraInfoUtils::ExtraInfoUtils() {
  g_extra_attrs_map_ = {
    ...
    {"elementwise_add", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_add_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"elementwise_div", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_div", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"elementwise_pow", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_pow_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"elementwise_floordiv", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_fmax", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_fmax_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_fmin", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_fmin_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"frobenius_norm", { {"use_mkldnn", bool{false}} }},
    {"frobenius_norm_grad", { {"use_mkldnn", bool{false}} }},
    {"fill_constant", { {"use_mkldnn", bool{false}} }},
    {"gather", { {"overwrite", bool{true}} }},
    {"gather_grad", { {"overwrite", bool{true}} }},
    ...
    {"grad_add", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"elementwise_heaviside", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_heaviside_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"matmul_v2", { {"use_mkldnn", bool{false}}, {"fused_reshape_Out", std::vector<int>{}}, {"fused_transpose_Out", std::vector<int>{}}, {"mkldnn_data_type", std::string{"float32"}}, {"fused_reshape_X", std::vector<int>{}}, {"fused_reshape_Y", std::vector<int>{}}, {"fused_transpose_X", std::vector<int>{}}, {"fused_transpose_Y", std::vector<int>{}} }},
    {"matmul_v2_grad", { {"use_mkldnn", bool{false}}, {"fused_reshape_Out", std::vector<int>{}}, {"fused_transpose_Out", std::vector<int>{}}, {"mkldnn_data_type", std::string{"float32"}}, {"fused_reshape_X", std::vector<int>{}}, {"fused_reshape_Y", std::vector<int>{}}, {"fused_transpose_X", std::vector<int>{}}, {"fused_transpose_Y", std::vector<int>{}} }},
    ...
    {"elementwise_max", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_max_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"elementwise_mul", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_mul_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    ...
    {"relu6", { {"use_mkldnn", bool{false}} }},
    {"relu6_grad", { {"use_mkldnn", bool{false}} }},
    {"elementwise_mod", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"renorm", { {"use_mkldnn", bool{false}}, {"use_cudnn", bool{false}} }},
    {"renorm_grad", { {"use_mkldnn", bool{false}}, {"use_cudnn", bool{false}} }},
    {"rnn", { {"is_test", bool{false}} }},
    {"rnn_grad", { {"is_test", bool{false}} }},
    ...
    {"softmax", { {"use_cudnn", bool{false}}, {"use_mkldnn", bool{false}}, {"mkldnn_data_type", std::string{"float32"}}, {"is_test", bool{false}} }},
    {"softmax_grad", { {"use_cudnn", bool{false}}, {"use_mkldnn", bool{false}}, {"mkldnn_data_type", std::string{"float32"}}, {"is_test", bool{false}} }},
    {"softplus", { {"use_mkldnn", bool{false}}, {"use_cudnn", bool{false}}, {"fuse_activation_type", std::string{""}}, {"fuse_activation_alpha", float{0.0f}}, {"fuse_activation_beta", float{0.0f}}, {"fuse_activation_scale", float{1.0f}} }},
    {"softplus_grad", { {"use_mkldnn", bool{false}}, {"use_cudnn", bool{false}}, {"fuse_activation_type", std::string{""}}, {"fuse_activation_alpha", float{0.0f}}, {"fuse_activation_beta", float{0.0f}}, {"fuse_activation_scale", float{1.0f}} }},
    ...
    {"stack", { {"use_mkldnn", bool{false}} }},
    {"stack_grad", { {"use_mkldnn", bool{false}} }},
    {"elementwise_sub", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"elementwise_sub_grad", { {"use_mkldnn", bool{false}}, {"x_data_format", std::string{""}}, {"y_data_format", std::string{""}}, {"mkldnn_data_type", std::string{"float32"}}, {"use_quantizer", bool{false}}, {"Scale_x", float{1.0f}}, {"Scale_y", float{1.0f}}, {"Scale_out", float{1.0f}} }},
    {"swish", { {"use_mkldnn", bool{false}} }},
    {"swish_grad", { {"use_mkldnn", bool{false}} }},
    ...
    {"transpose2", { {"use_mkldnn", bool{false}}, {"data_format", std::string{"AnyLayout"}}, {"use_quantizer", bool{false}}, {"mkldnn_data_type", std::string{"float32"}} }},
    {"transpose2_grad", { {"use_mkldnn", bool{false}}, {"data_format", std::string{"AnyLayout"}}, {"use_quantizer", bool{false}}, {"mkldnn_data_type", std::string{"float32"}} }},
  ...
  g_extra_attrs_checker_ = {
    ...
    {"gather", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("overwrite", true)(attr_map, only_check_exist_value);} }},
    {"gather_grad", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("overwrite", true)(attr_map, only_check_exist_value);} }},
    ...
    {"matmul_v2", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_reshape_Out", {})(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_transpose_Out", {})(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::string>("mkldnn_data_type", "float32")(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_reshape_X", {})(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_reshape_Y", {})(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_transpose_X", {})(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::vector<int>>("fused_transpose_Y", {})(attr_map, only_check_exist_value);} }},
    ...
    {"renorm_grad", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_cudnn", false)(attr_map, only_check_exist_value);} }},
    {"rnn", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("is_test", false)(attr_map, only_check_exist_value);} }},
    {"rnn_grad", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("is_test", false)(attr_map, only_check_exist_value);} }},
    ...
    {"slice_grad", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::string>("mkldnn_data_type", "float32")(attr_map, only_check_exist_value);} }},
    {"softmax", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_cudnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::string>("mkldnn_data_type", "float32")(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("is_test", false)(attr_map, only_check_exist_value);} }},
    {"softmax_grad", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_cudnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::string>("mkldnn_data_type", "float32")(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("is_test", false)(attr_map, only_check_exist_value);} }},
    {"softplus", { [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_mkldnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<bool>("use_cudnn", false)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<std::string>("fuse_activation_type", "")(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<float>("fuse_activation_alpha", 0.0f)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<float>("fuse_activation_beta", 0.0f)(attr_map, only_check_exist_value);},
      [](framework::AttributeMap* attr_map, bool only_check_exist_value)-> void { ExtraAttrChecker<float>("fuse_activation_scale", 1.0f)(attr_map, only_check_exist_value);} }},
