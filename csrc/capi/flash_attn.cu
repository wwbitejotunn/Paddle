...
void set_params_fprop(Flash_fwd_params &params,
                      ...
                      void * const chunked_seq_sink_token_mask_lens_k,
                      void * const chunked_seq_continus_token_lens_k,
                      void * const p_d,
    ...
    params.chunked_seq_sink_token_mask_lens_k = static_cast<int*>(chunked_seq_sink_token_mask_lens_k);
    params.chunked_seq_continus_token_lens_k = static_cast<int*>(chunked_seq_continus_token_lens_k);
    // P = softmax(QK^T)
    params.p_ptr = p_d;
...
void set_params_dgrad(Flash_bwd_params &params,
    ...
    set_params_fprop(params,
                     ...
                     /*chunked_seq_sink_token_mask_lens_k*/nullptr,
                     /*chunked_seq_continus_token_lens_k*/nullptr,
                     nullptr,
                     softmax_lse_d,
                     p_dropout,
                     softmax_scale,
...
bool flash_attn_varlen_fwd(const void * const q,
    ...
    set_params_fprop(params,
                     ...
                     const_cast<int32_t *>(chunked_seq_sink_token_mask_lens_k),
                     const_cast<int32_t *>(chunked_seq_continus_token_lens_k),
                     return_softmax ? softmax_ptr : nullptr,
                     softmax_lse_ptr,
                     p_dropout,
                     softmax_scale,
